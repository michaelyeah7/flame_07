...
fig_size(1) = s(3)-310;  % GJZ: formerly s(3)-200;
fig_size(2) = 50;
fig_size(3) = 300;       % GJZ: formerly 190;
...
% read the data
MRDS.data = fread(fid, [MRDS.cols,MRDS.rows],'float');
MRDS.data=MRDS.data';
fclose(fid);
...
fig_size(1) = 10;
fig_size(2) = 150;
fig_size(3) = s(3)-300-fig_size(1)-scrollbar_width;  % GJZ: formerly s(3)-210-fig_size(1)-scrollbar_width;
fig_size(4) = s(4)-50-fig_size(2);
