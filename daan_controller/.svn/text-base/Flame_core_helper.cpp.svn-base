...
static void run_event_loop(void)
{
  ...
  while ( keep_running ) {
	...
	// first check for inertial sensor data and send this to rt
	...
	msg.roll    = data.roll;
	msg.rolld   = data.rolld;
	msg.pitchd  = data.pitchd;
    ...
    // only then take action on receiving messages
